                ...
                ScrollView(.vertical) {
                    ...
                    case .success:
                        LazyVStack{
                            ...
                            HorizontalListView(header: Constants.topRatedTvString, titles: viewModel.topRatedMovies){ title in
                                titleDetailPath.append(title)
                                
                            }
                            HorizontalListView(header: Constants.topRatedMovieString, titles: viewModel.topRatedTV){ title in
                                titleDetailPath.append(title)
